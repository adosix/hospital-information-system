...
INSERT INTO auth_user (password,last_login,is_superuser,username,first_name,last_name,email,is_staff,is_active,date_joined)
    VALUES("pbkdf2_sha256$216000$gnBtZDycJSVv$OfH0fE7/8AWg8TocXXG0Rd9/P6UWuk2q0gyrn60lt7U=","2020-10-15 21:40:34.113892", "1", "Rodri0","Nuha","Rodriquez","nu_rodri@goog.com","0","1","2020-10-18 21:40:34.113892");
INSERT INTO auth_user (password,last_login,is_superuser,username,first_name,last_name,email,is_staff,is_active,date_joined)
    VALUES("pbkdf2_sha256$216000$gnBtZDycJSVv$OfH0fE7/8AWg8TocXXG0Rd9/P6UWuk2q0gyrn60lt7U=","2020-08-18 21:40:34.113892", "1", "Ponce0","Johnny","Ponce","johnnypo@pst.com","0","1","2020-10-18 21:40:34.113892");
...
SELECT id
FROM  auth_user
WHERE username = "Rodri0";
INSERT INTO hospital_is_insurance_worker
SELECT id
FROM  auth_user
WHERE username = "Ponce0";
...
SELECT id
FROM  auth_user
WHERE username = "Cohen0";
INSERT INTO hospital_is_doctor
SELECT id
FROM  auth_user
WHERE username = "Firth0";
INSERT INTO hospital_is_doctor
SELECT id
FROM  auth_user
WHERE username = "Mcnal0";
INSERT INTO hospital_is_doctor
SELECT id
FROM  auth_user
WHERE username = "Pope0";
INSERT INTO hospital_is_doctor
SELECT id
FROM  auth_user
...
SELECT id
FROM  auth_user
WHERE username = "Kouma0";
INSERT INTO hospital_is_admin
SELECT id
FROM  auth_user
WHERE username = "Jense0";
...
VALUES ("preventivne vysetrenie","Toto je preventivne vysetrenie, kde sa najma vysetri cuch a chut, kedze bez cuchu je korona",(SELECT id FROM  auth_user WHERE username = "Rodri0"));

INSERT INTO hospital_is_compensated_operations
VALUES ("ockovanie","Toto je ockovanie na zakladne druhy chorob, ako je tetanovka.",(SELECT id FROM  auth_user WHERE username = "Rodri0"));
INSERT INTO hospital_is_compensated_operations
VALUES ("rontgen","Rontgen je bezplatny len v pripade podozrenia na zlomeninu.",(SELECT id FROM auth_user WHERE username = "Ponce0"));
INSERT INTO hospital_is_compensated_operations
...
VALUES ("0",(SELECT id FROM hospital_is_medical_problem WHERE Title = "Stressful Ebola"),(SELECT id FROM  auth_user  WHERE username = "Mckeo0"), "perform an anti-stress examination", "none");
INSERT INTO hospital_is_ticket(id, Medical_Problem_ID, Doctor_ID, Operation, description)
VALUES ("1",(SELECT id FROM hospital_is_medical_problem WHERE Title = "Stressful Ebola"),(SELECT id FROM  auth_user  WHERE username = "Cohen0"), "perform a very stressful examination", "none");
INSERT INTO hospital_is_ticket(id, Medical_Problem_ID, Doctor_ID, Operation, description)
